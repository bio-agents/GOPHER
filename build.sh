...
ANT_HOME="$XCESC_HOME/agents-ant"
...
JAVA_ENDORSED_DIRS="$XCESC_HOME"/agents-endorsed
...
exec "$JAVA_HOME"/bin/java -Xms512m -Xmx512m "${JAVA_OPTS[@]}" -classpath "$LOCALCLASSPATH" org.apache.agents.ant.launch.Launcher "$@"